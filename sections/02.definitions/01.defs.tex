...
\begin{definition}
  ...
  angular density, $d_{\bm{l}}, d_{\alpha} \in \mathbb{N}$, of a $\psi$- or
  $r$-field respectively denote the number of pose estimates dispersed on a
  given map $\bm{M}$ per unit area of space and per angular cycle.
\end{definition}
