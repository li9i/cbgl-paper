...
$k$ lowest CAER values, CBGL utilises scan--to--map-scan matching (\texttt{sm2})
...
\ref{fig:block_system} (left) and algorithm \ref{alg:cbgl} present the proposed
method of CBGL in block diagram and algorithmic forms respectively.
