...
\begin{customhpt}{H}
  ...
  There exist $\delta,\delta_0 \in \mathbb{R}_{> 0}$ such that
  \begin{itemize}
    \item $\hat{\bm{p}}: \|\bm{p}-\hat{\bm{p}}\|_2 \leq \delta \leq \delta_0$
          is an admissible pose estimate solution to Problem
          \ref{prob:the_problem}, and
...
restrictively states that $\mathcal{V}$ is populated by a pose estimate
