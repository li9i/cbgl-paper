...
In sum the proposed method retains the positive qualities of the two main approaches to global
...
in a neighbourhood of the sensor's true pose%, and its computational complexity is low
