...
inlier rate for each pose in WAREHOUSE, and the highest number of inliers in
WILLOWGARAGE.
...
overlying scan--to--map-scan matching method. CBGL is tested against $N_E =
45402$ environments, generated via the experimental procedure of
