...
\begin{picture}(4600.00,3000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(-160,1499){\rotatebox{90}{\makebox(0,0){\strut{}\small $f_{\psi}$ [m]}}}%
      \colorrgb{0.15,0.15,0.15}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.15,0.15,0.15}%
    ...
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.15,0.15,0.15}%
      %\put(2400,1499){\rotatebox{90}{\makebox(0,0){\strut{}\small hypothesis' rank in \texttt{r}-field}}}%
      \put(2400,1499){\rotatebox{90}{\makebox(0,0){\strut{}\small $f_{\texttt{r}}$}}}%
      \colorrgb{0.15,0.15,0.15}%
      \put(2300,-250){\makebox(0,0){\strut{}\small estimate error \footnotesize [(m$^2$ + rad$^2$)$^{1/2}$]}}%
      \put(1300,3000){\makebox(0,0){\makebox(0,0){\strut{}{\color{v}{\rule[0.6mm]{0.5cm}{0.75mm}}} $\mathcal{V}$}}}%
      \put(2300,3000){\makebox(0,0){\makebox(0,0){\strut{}{\color{x}{\rule[0.6mm]{0.5cm}{0.75mm}}} $\mathcal{X}$}}}%
      \put(3300,3000){\makebox(0,0){\makebox(0,0){\strut{}{\color{w}{\rule[0.6mm]{0.5cm}{0.75mm}}} $\mathcal{W}$}}}%
    }%
    \put(0,0){\includegraphics{./figures/h_fig}}%
    \gplfronttext
  \end{picture}%
\endgroup
